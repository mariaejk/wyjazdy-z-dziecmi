...
export function CookieBanner() {
  ...
  const buttonBase =
    "w-full rounded-none border border-graphite px-4 py-2.5 text-sm font-medium transition-colors sm:w-auto";
          ...
          <>
            ...
            <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:gap-3">
              <button
                ...
                className={cn(buttonBase, "bg-graphite text-white hover:bg-black")}
              >
              ...
              <button
                ...
                className={cn(buttonBase, "bg-white text-graphite hover:bg-parchment-dark")}
              >
                Tylko niezbędne
              </button>
              <button
            ...
            <div className="mt-4 space-y-3">
              ...
              <label className="flex items-center gap-3">
                <input
                  ...
                  checked
                  disabled
                  className="h-4 w-4 rounded border-graphite/20 text-graphite"
                />
              ...
              <label className="flex items-center gap-3">
                <input
                  ...
                  className="h-4 w-4 rounded border-graphite/20 text-graphite focus:ring-2 focus:ring-graphite/20 focus:ring-offset-0"
                />
                <span className="text-sm text-graphite">
