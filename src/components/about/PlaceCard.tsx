...
export function PlaceCard({ place, index = 0 }: PlaceCardProps) {
  ...
  return (
    <ScrollAnimation variant="fadeUp" delay={index * 0.15}>
      <div className="rounded-none border border-graphite/10 bg-white p-6 sm:p-8">
        <div className="mb-4 flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-none bg-moss/10">
