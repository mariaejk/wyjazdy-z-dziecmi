    ...
    <SectionWrapper variant={variant}>
      <Container>
        ...
        >
          ...
          >
            {member.image ? (
              <div className="relative h-80 w-64 overflow-hidden rounded-none bg-parchment-dark shadow-xl sm:h-[420px] sm:w-80 lg:h-[500px] lg:w-96">
                <Image
                  src={member.image}
                  alt={member.name}
                  fill
              ...
              <div className="flex h-80 w-64 items-center justify-center rounded-none bg-moss/10 lg:h-[500px] lg:w-96">
                <User
