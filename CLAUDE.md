...
- **Dark form styling pattern**: On `bg-graphite`: inputs use `border-white/20 bg-white/10 text-white placeholder:text-white/40`, checkboxes use `border-white/20 bg-white/10 text-mustard`, labels use `text-white/50`, CTA button uses `bg-mustard text-graphite`. Focus rings: `ring-mustard/30 ring-offset-graphite`.
