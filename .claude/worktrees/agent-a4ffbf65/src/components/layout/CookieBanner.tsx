...
export function CookieBanner() {
  ...
  const buttonBase =
    "w-full rounded-md border border-moss px-4 py-2.5 text-sm font-medium transition-colors sm:w-auto";
          ...
          <>
            ...
            <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:gap-3">
              <button
                ...
                className={cn(buttonBase, "bg-moss text-white hover:bg-moss-light")}
              >
